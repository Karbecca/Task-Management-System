...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Efficient Task Management");

        jLabel6.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("with Qualified Staff.");

        jLabel7.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("for Server Administration");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\Downloads\\icons8-management-ios-17-filled\\icons8-management-50.png")); // NOI18N
    ...
    if (email.isEmpty() || password.isEmpty()) {
        ...
        Admin loggedInAdmin = adminDao.loginAdmin(email, password);
        if (loggedInAdmin != null) {
            // Login successful, show success message
            JOptionPane.showMessageDialog(this, "Login successful. Redirecting to the home page...", "Success", JOptionPane.INFORMATION_MESSAGE);

            // Redirect to the home page
            HomeForm homeForm = new HomeForm(); // Assuming HomeForm takes Admin as a parameter
